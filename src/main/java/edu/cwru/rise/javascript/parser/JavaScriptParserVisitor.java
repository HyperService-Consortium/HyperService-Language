...
public interface JavaScriptParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#varFunDefinition}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitVarFunDefinition(JavaScriptParser.VarFunDefinitionContext ctx);
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#varFunPrototype}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitVarFunPrototype(JavaScriptParser.VarFunPrototypeContext ctx);
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#prototypeBody}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrototypeBody(JavaScriptParser.PrototypeBodyContext ctx);
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#functionList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunctionList(JavaScriptParser.FunctionListContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#localStorage}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLocalStorage(JavaScriptParser.LocalStorageContext ctx);
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#contractDefinition}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitContractDefinition(JavaScriptParser.ContractDefinitionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#variableDefinition}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitVariableDefinition(JavaScriptParser.VariableDefinitionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code PrototypeExpression}
	 * labeled alternative in {@link JavaScriptParser#singleExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrototypeExpression(JavaScriptParser.PrototypeExpressionContext ctx);
	/**
